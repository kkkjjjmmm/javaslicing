...
public class OriginalPDFSlice {
  ...
  public static Process run(String[] args) throws IllegalArgumentException, CancelException, IOException {
    ...
    return run(p.getProperty("appJar"), p.getProperty("mainClass"), p.getProperty("srcCaller"), p.getProperty("srcCallee"),
        goBackward(p), D_OPTIONS,C_OPTIONS);
  }
  ...
  public static Process run(String appJar, String mainClass, String srcCaller, String srcCallee, boolean goBackward,
    ...
    try {
      ...
      CGNode callerNode = com.ibm.wala.examples.drivers.SlicerTest.findMethod(cg, srcCaller);
     // Statement s = com.ibm.wala.examples.drivers.SlicerTest.findCallTo(callerNode, srcCallee);
      //System.err.println("Statement: " + s);
      
//      ControlFlowGraph<SSAInstruction, ISSABasicBlock> cfg = callerNode.getIR().getControlFlowGraph();
//      PrunedCFG<SSAInstruction, ISSABasicBlock> prunedCFG = ExceptionPrunedCFG.make(cfg);
//      cfg = prunedCFG;
//      ControlDependenceGraph<ISSABasicBlock> cdg = new ControlDependenceGraph<ISSABasicBlock>(cfg);    
      PDG<InstanceKey> pdg = sdg.getPDG(callerNode);
      
      Graph<Statement> g = pdg;
...
//      com.ibm.wala.examples.drivers.SlicerTest.dumpSlice(slice);
   ...
   //   sanityCheck(slice, g);
      ...
      String psFile = "/home/WALA/WALA-START/"+PDF_FILE;
